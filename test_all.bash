...
assertCurl 422 "curl http://$HOST:$PORT/product-composite/113 -s"
assertEqual "\"Invalid productId: -1\"" "$(echo $RESPONSE | jq .message)"

# Verify that a 400 (Bad Request) error error is returned for a productId that is not a number, i.e. invalid formatCollaps
assertCurl 400 "curl http://$HOST:$PORT/product-composite/113 -s"
